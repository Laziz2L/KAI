...
public class LaScene {
    ...
    void function() {
        ...
        FlowPane.setMargin(this.cnv, new Insets(100,0,0,300));
        FlowPane.setMargin(this.checkBox3, new Insets(730,0,0,-1500));
        FlowPane.setMargin(this.btn4, new Insets(730,0,0,20));
        FlowPane.setMargin(this.btn5, new Insets(730,0,0,20));
        FlowPane.setMargin(this.btn6, new Insets(730,0,0,20));
        FlowPane.setMargin(this.btn7, new Insets(730,0,0,20));
        FlowPane.setMargin(this.checkBox4, new Insets(730,0,0,20));
        FlowPane.setMargin(this.btn8, new Insets(730,0,0,20));



    }

    LaScene(Canvas cnv, GraphicsContext gc, Label lbl2, Label lbl3, Button btn1, Button btn2, Button btn3, Label lbl4,
            ChoiceBox<String> choiceBox, CheckBox checkBox, Rectangle rect, Scene scene, Label lbl5, TextField tf2,
            Label lbl6, TextField tf3, CheckBox checkBox2, Label lbl7, TextField tf4, Label lbl8, TextField tf5,
            CheckBox checkBox3, Button btn4, Button btn5, Button btn6, Button btn7, CheckBox checkBox4, Button btn8) {
